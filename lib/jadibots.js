const captionPairing = `*\`「🤍」 Serbot - Code 「🤍」\`*
    ...
    if (_0x1fccbf === "close") {
      ...
      if (_0x1fccbf === "open" && !_0x581ff9) {
        if (_0xa5eb5e && _0xa5eb5e?.["chat"]) {
          await sexo(_0xa5eb5e.chat, "*`[ Conectado Exitosamente ✅ ]`*\n\n> _Se intentara reconectar en caso de desconexion de sesion_\n> _Si quieres eliminar el subbot borra la sesion en dispositivos vinculados_\n> _El número del bot puede cambiar, guarda este enlace :_\n\nhttps://whatsapp.com/channel/0029VaJxgcB0bIdvuOwKTM2Y", _0xa5eb5e);
        }
      }
    }
    if (_0x1a5e6f) {
