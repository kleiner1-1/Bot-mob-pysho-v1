...
await conn.sendMessage(m.chat, { text: `MOBPYSHO-Bot: no hay sesión activa.\nUsa: ${usedPrefix + command}\nSi tienes ID:\n${usedPrefix + command} (ID)` }, { quoted: m })
return
}
if (global.conn.user.jid !== conn.user.jid) {
  ...
  await conn.sendMessage(m.chat, { text: `MOBPYSHO-Bot: sub-bot desconectado.` }, { quoted: m })
}
try {
...
if (global.conn.user.jid == conn.user.jid) {
  ...
  await conn.reply(m.chat, `MOBPYSHO-Bot desactivado.`, m)
  conn.ws.close()
}  
break
