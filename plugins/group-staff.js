...
`.trim();
  ...
  try {
    ...
    const imageUrl = global.imageUrl || "https://files.catbox.moe/3mia0l.jpg"; // Imagen predeterminada
    const sourceUrl = global.redes || "https://github.com/Deylinel/TECNO-BOT-OFICIAL"; // URL del proyecto
    const thumbnailUrl = global.icono || "https://files.catbox.moe/3mia0l.jpg"; // Miniatura
